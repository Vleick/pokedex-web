...
# Interfaz principal
st.markdown("<h1 style='display:flex; align-items:center; gap:12px;'>"
                 "🔎 Pokédex Web <span style='font-family:Freestyle Script, cursive; font-size: 0.6em;'>by Vleick</span>"
